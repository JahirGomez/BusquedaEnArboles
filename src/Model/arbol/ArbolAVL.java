...
public class ArbolAVL {
	...
	public void insertarPorNombre(Egresado o){
    	insertarOrdenadoPorNombre(raiz,o);
    }

	public void insertarPorProfesion(Egresado o){
    	insertarOrdenadoPorProfesion(raiz,o);
    }
      
    private void insertarOrdenadoPorPromedio(NodoAVL n, Egresado o){  
	...
	private void insertarOrdenadoPorNombre(NodoAVL n, Egresado o){  
    	if (o.getName().compareTo(n.dato.getName())<0){
       		if (n.getIzq()==null){
           		n.setIzq(new NodoAVL(o,null,null,n));
           		recalcularFE(n);
       		}else{
	...
	private void insertarOrdenadoPorProfesion(NodoAVL n, Egresado o){  

...
public class Raiz {
    ...
    public void setTengoHijos (NodoArbol nodo) {
        if (nodo == primerNodo) {
    ...
    public void ingresarEnHijos(NodoArbol conHijos, int valor) {
        boolean entro = false;
    ...
    public void ubicarValorEnArreglo(NodoArbol nodoA, int valor){
        int cont = 0;
        while(cont <= 2*grado){
     ...
     public void ordenarNodos(NodoArbol aOrdenar){
       int i,j;
       i = 0;
       NodoArbol tmp;
    ...
    public void split (NodoArbol nodo) {

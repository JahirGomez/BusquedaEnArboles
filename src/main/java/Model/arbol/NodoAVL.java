...
public class NodoAVL extends NodoBin{
    ...
    public NodoAVL(ListaDoble o){
        super(o);
    }
    
    public NodoAVL(ListaDoble o,NodoAVL i, NodoAVL d){
        super(o,d,i);
    }
    
    public NodoAVL(ListaDoble o,NodoAVL i, NodoAVL d, NodoAVL p){
        super(o,d,i);
        padre = p;
    }
    ...
    if(izq!=null)
        ((NodoAVL)izq).inOrden();
        System.out.println("| FE :" + FE);//Raiz
        if(dato.inicio.getSiguiente()!=null){
            NodoDoble actual = dato.inicio.getSiguiente();
            while(actual!=null){
